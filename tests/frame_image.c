...
int main(int argc, char** argv)
{
	...
	const char *    filename                = "misc/grenoble.jpg";
	ei_surface_t    frame_image = hw_image_load(filename, ei_app_root_surface());
